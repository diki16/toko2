            ...
            <div class="p-5">
              ...
              <form class="user" method="post" action="<?php echo base_url('auth/registrasi') ?>">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type="password" class="form-control form-control-user" id="password2" name="password2" placeholder="Ulangi Password Kamu Takut lupa">
                  </div>
                </div>
              ...
              <hr>
              <div class="text-center">
                <a class="small" href="<?php echo base_url('auth/lupapssword');?>">Lupa Password?</a>
              </div>
              <div class="text-center">
                <a class="small" href="<?php echo base_url('auth');?>">Udah Punya Akun ? Ayo Ke Login!</a>
              </div>
            </div>
          </div>
        </div>
